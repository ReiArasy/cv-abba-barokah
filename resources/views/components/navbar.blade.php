<nav class="bg-white text-slate-800 shadow-sm border-b border-gray-100">
    <div class="container mx-auto px-6 md:px-12 py-5 flex justify-between items-center">
        ...
        <a href="{{ route('home') }}" class="bg-white-50 p-2 hover:bg-gray-100 transition flex items-center justify-center">
            <img src="{{ asset('storage/products/Logo.png') }}" class="w-auto h-8 object-contain" alt="Logo CV ABBA BAROKAH">
        </a>
