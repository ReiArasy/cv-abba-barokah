...
<div class="ui-font bg-gray-50 min-h-screen py-12">
    <div class="container mx-auto px-6 md:px-12 max-w-5xl">
        ...
        <!-- Alamat & Kontak CTA Section -->
        <div class="bg-teal-ui text-white rounded-lg p-8 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
            ...
            <a href="{{ route('home') }}#main-footer" class="bg-white text-teal-ui px-6 py-3 rounded text-xs font-bold shadow hover:bg-gray-50 transition no-underline">
                Hubungi Kontak Kami
            </a>
        </div>
